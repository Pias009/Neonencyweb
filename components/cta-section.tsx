  ...
  return (
    <section ref={sectionRef} className="py-32 px-4">
      <div className="max-w-4xl mx-auto">
        <div
          ref={contentRef}
          className="relative glass-strong rounded-3xl p-16 text-center border-2 border-white/20 hover:border-cyan-400/30 transition-all duration-500 overflow-hidden"
        >
          {/* Background effects */}
          ...
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-cyan-400/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '3s' }} />
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl md:text-5xl font-black orbitron neon-text mb-6">
              Ready to Experience the Future?
            </h2>
            
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join thousands of companies already using NEONENCY to transform their business with cutting-edge technology.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link href="/products">
                <Button 
                  variant="outline"
                  size="lg" 
                  className="glass hover:glass-strong transition-all duration-300 px-8 py-4 text-lg orbitron font-medium rounded-2xl"
                >
                  Explore Products
                </Button>
              </Link>
